...
#include <iostream>
#include <string>
<<<<<<< HEAD:Estructuras/Grafo/Recursos/Vertex/Vertex.hpp
#include "../DLLTemplate/DLL.hpp"
=======
#include <estructuras/DLL.hpp>
>>>>>>> test:include/estructuras/Vertex.hpp
...
private:
	...
	/**!<Tiempo final del vertex*/
	size_t finish_time{ 0 };

	/**!<Posición en x del vertex*/
	int x { 0 };

	/**!<Posición en y del vertex*/
	int y { 0 };
