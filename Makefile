...
#----------------Estructuras---------------------#
Grafo.o:Estructuras/Grafo/Grafo.hpp Estructuras/Grafo/Grafo.cpp
	g++ -Wall -g -DDEBUG  -c "Estructuras/Grafo/Grafo.cpp" -o "PacMan/bin/Grafo.o"

Vertex.o:Estructuras/Grafo/Recursos/Vertex.hpp Estructuras/Grafo/Recursos/Vertex.cpp
	g++ -Wall -g -DDEBUG  -c "Estructuras/Grafo/Recursos/Vertex.cpp" -o "PacMan/bin/Vertex.o"
#-------------------Main-------------------------#
main.o:PacMan/main.cpp miniwin.o
	g++ -Wall -g -DDEBUG  -c "PacMan/main.cpp" -o "PacMan/bin/main.o"

Pacman:main.o miniwin.o Cuadro.o Figura.o Fantasma.o Pacman.o Comida.o Tablero.o Grafo.o Vertex.o
	g++  -o "PacMan/bin/PacMan" "PacMan/bin/main.o" "PacMan/bin/miniwin.o" "PacMan/bin/Cuadro.o" "PacMan/bin/Figura.o" "PacMan/bin/Fantasma.o" "PacMan/bin/Pacman.o" "PacMan/bin/Comida.o" "PacMan/bin/Tablero.o" "PacMan/bin/Grafo.o" "PacMan/bin/Vertex.o" -pthread  -lX11
